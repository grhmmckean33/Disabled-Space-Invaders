...
class Scoreboard:
    ...
    def prep_ships(self):
        ...
        for ship_number in range(self.stats.ships_left):
            ...
            # Load the lives icon image and get its rect.
            lives_image = pygame.image.load('sw3.png')
            lives_image = pygame.transform.scale(lives_image, (60, 60))
            ship.image = lives_image
